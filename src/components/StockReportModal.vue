                ...
                <div class="modal-sheet report-sheet">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="number" v-model="modalQty" class="form-input" placeholder="0" step="0.1">
                        </div>
                        <div class="form-group">
...
.btn.danger { background: #EF4444; border-color: #EF4444; border: 1px solid #EF4444; color: white; padding: 12px; font-weight: 900; font-size: 0.8rem; cursor: pointer; }
